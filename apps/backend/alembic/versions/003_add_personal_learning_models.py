...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("userId", sa.String(), sa.ForeignKey("User.id", ondelete="CASCADE"), nullable=False, index=True),
        ...
        sa.Column("prepId", sa.String(), sa.ForeignKey("ExamPrep.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("userId", sa.String(), sa.ForeignKey("User.id", ondelete="CASCADE"), nullable=False, index=True),
        sa.Column("deckId", sa.String(), sa.ForeignKey("FlashcardDeck.id", ondelete="SET NULL"), nullable=True, index=True),
    ...
    op.create_index("SavedResource_userId_sourceType_idx", "SavedResource", ["userId", "sourceType"])
    ...
    op.create_table(
        "LearningProfile",
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("userId", sa.String(), sa.ForeignKey("User.id", ondelete="CASCADE"), nullable=False, unique=True, index=True),
    ...
    op.create_table(
        "PrepTopic",
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("prepId", sa.String(), sa.ForeignKey("ExamPrep.id", ondelete="CASCADE"), nullable=False, index=True),
        sa.Column("title", sa.String(), nullable=False),
    ...
    op.create_table(
        "QuizQuestion",
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("quizSessionId", sa.String(), sa.ForeignKey("QuizSession.id", ondelete="CASCADE"), nullable=False, index=True),
        sa.Column("prepTopicId", sa.String(), sa.ForeignKey("PrepTopic.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("quizSessionId", sa.String(), sa.ForeignKey("QuizSession.id", ondelete="CASCADE"), nullable=False, index=True),
        sa.Column("questionId", sa.String(), sa.ForeignKey("QuizQuestion.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        "StudyPlanItem",
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("planId", sa.String(), sa.ForeignKey("StudyPlan.id", ondelete="CASCADE"), nullable=False, index=True),
        sa.Column("title", sa.String(), nullable=False),
        sa.Column("description", sa.Text(), nullable=True),
    ...
    op.create_index("StudyPlanItem_planId_scheduledDate_idx", "StudyPlanItem", ["planId", "scheduledDate"])
    ...
    op.create_index("DiscoveryRecommendation_userId_status_idx", "DiscoveryRecommendation", ["userId", "status"])
    ...
    op.create_index("ActivityFeedEntry_userId_occurredAt_idx", "ActivityFeedEntry", ["userId", "occurredAt"])
