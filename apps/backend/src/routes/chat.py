    ...
    try:
        while True:
            ...
            if context and context.get("sessionId"):
                ...
                try:
                    pinned = await db.chatsession.find_unique(where={"id": requested_session_id})
                    if pinned:
            ...
            circle_credit_id = circle_group.circleId if is_circle_session and circle_group else None
