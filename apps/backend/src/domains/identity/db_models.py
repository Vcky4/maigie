...
class User(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    verification_code: Mapped[Optional[str]] = mapped_column(
        "verificationCode", String, nullable=True
    )
    ...
    password_reset_code: Mapped[Optional[str]] = mapped_column(
    ...
    subscription_current_period_start: Mapped[Optional[datetime]] = mapped_column(
    ...
    # Billing (Paystack)
    paystack_customer_code: Mapped[Optional[str]] = mapped_column(
    ...
    payment_provider: Mapped[Optional[str]] = mapped_column(
        "paymentProvider", String, nullable=True
    )

    # Billing (Google Play)
    google_play_purchase_token: Mapped[Optional[str]] = mapped_column(
        "googlePlayPurchaseToken", String, unique=True, nullable=True
    )
    google_play_product_id: Mapped[Optional[str]] = mapped_column(
    ...
    credits_period_end: Mapped[Optional[datetime]] = mapped_column(
        "creditsPeriodEnd", DateTime(timezone=True), nullable=True
    )
    credits_soft_cap: Mapped[Optional[int]] = mapped_column(
        "creditsSoftCap", Integer, nullable=True
    )
    credits_hard_cap: Mapped[Optional[int]] = mapped_column(
        "creditsHardCap", Integer, nullable=True
    )
    ...
    credits_daily_limit: Mapped[Optional[int]] = mapped_column(
    ...
    file_uploads_period_start: Mapped[Optional[datetime]] = mapped_column(
    ...
    summary_generations_period_start: Mapped[Optional[datetime]] = mapped_column(
        "summaryGenerationsPeriodStart", DateTime(timezone=True), nullable=True
    )

    # Google Calendar
    google_calendar_access_token: Mapped[Optional[str]] = mapped_column(
    ...
    google_calendar_token_expires_at: Mapped[Optional[datetime]] = mapped_column(
    ...
    account_deletion_scheduled_for: Mapped[Optional[datetime]] = mapped_column(
        "accountDeletionScheduledFor", DateTime(timezone=True), nullable=True
    )
    account_deletion_cancel_token: Mapped[Optional[str]] = mapped_column(
        "accountDeletionCancelToken", String, nullable=True
    )
    account_deletion_reminder_30_sent_at: Mapped[Optional[datetime]] = mapped_column(
        "accountDeletionReminder30SentAt", DateTime(timezone=True), nullable=True
    )
    account_deletion_reminder_7_sent_at: Mapped[Optional[datetime]] = mapped_column(
        "accountDeletionReminder7SentAt", DateTime(timezone=True), nullable=True
    )
    account_deletion_last_cancelled_at: Mapped[Optional[datetime]] = mapped_column(
    ...
    profile_image_status: Mapped[Optional[str]] = mapped_column(
    ...
    last_seen_platform: Mapped[Optional[str]] = mapped_column(
