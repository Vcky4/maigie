...
class ChatGenerationAttempt(Base):
    __tablename__ = "ChatGenerationAttempt"
    ...
    tool_side_effects: Mapped[bool] = mapped_column(
        "toolSideEffects", Boolean, default=False, server_default="false"
    )
    created_at: Mapped[datetime] = mapped_column(
        "createdAt",
        DateTime(timezone=True),
    ...
    __table_args__ = (
        Index("ChatGenerationAttempt_userId_createdAt_idx", "userId", "createdAt"),
        Index(
            "ChatGenerationAttempt_one_active_per_session",
            "sessionId",
            unique=True,
...
class LlmCostRecord(Base):
    ...
    attempt_id: Mapped[str | None] = mapped_column(
        "attemptId",
        String,
        ForeignKey("ChatGenerationAttempt.id", ondelete="SET NULL"),
        nullable=True,
        index=True,
    )
...
class UserInteractionMemory(Base):
    ...
    __table_args__ = (
        Index(
            "UserInteractionMemory_userId_interactionType_idx",
            "userId",
            "interactionType",
        ),
