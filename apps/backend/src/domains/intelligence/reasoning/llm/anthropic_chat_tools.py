...
from src.domains.intelligence.reasoning.llm.tool_normalizer import ToolNormalizer
...
class AnthropicChatToolsAdapter(BaseProviderAdapter):
    ...
    async def get_chat_response_with_tools(
        ...
        try:
            ...
            from src.domains.intelligence.reasoning.llm.types import ToolDefinition
