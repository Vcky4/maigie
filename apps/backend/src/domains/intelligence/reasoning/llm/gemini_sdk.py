...
All Gemini client construction should go through :func:`new_gemini_client` so
multi-provider work can swap implementations without scattering Client(...) calls.
"""
