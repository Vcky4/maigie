...
async def get_referral_stats(user: User) -> dict[str, Any]:
    ...
    from src.services.referral_service import get_referral_stats as _stats
...
async def get_claimable_rewards(user: User) -> list[dict[str, Any]]:
    ...
    from src.services.referral_service import get_claimable_rewards as _claimable
...
async def claim_reward(user: User, reward_id: str) -> dict[str, Any]:
    ...
    from src.services.referral_service import claim_referral_reward as _claim
