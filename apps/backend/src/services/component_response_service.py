...
async def format_action_component_response(
    ...
    if action_type == "create_course":
        ...
        schedule_id = schedule.get("id") or action_result.get("scheduleId") or action_result.get("schedule_id")
            ...
            try:
                ...
                if schedule_obj:
                    component_data = {
                        ...
                        "startAt": schedule_obj.startAt.isoformat() if schedule_obj.startAt else None,
                ...
                component_data = {
                    ...
                    "id": schedule_id,
                    "title": schedule.get("title") or action_data.get("title") if action_data else "Schedule",
                    "startAt": schedule.get("startAt") or action_data.get("startAt") if action_data else None,
                    "endAt": schedule.get("endAt") or action_data.get("endAt") if action_data else None,
                    "description": schedule.get("description") or action_data.get("description") if action_data else None,
                }
