...
class ActionService:
    ...
    async def create_course(self, data: dict, user_id: str, progress_callback=None):
        ...
        Enforces FREE tier limits: max 2 AI courses, 250 credits per generation.
        Applies to chat, onboarding, and any other caller.
        ...
        try:
            ...
            try:
                ...
                is_daily = (
                    tier == "FREE"
                    and daily_limit > 0
                    and (used_today + credits_needed > daily_limit)
                )
                return {
                    "status": "error",
                    "message": e.message,
            ...
            if not modules_data:
                ...
                print(f"📚 No modules provided, generating course outline for: {title}")
