"""
OAuth provider infrastructure — Google (and future providers).

Provides the authorization URL generation, token exchange, and user info
fetching for social login flows. Used by the Identity domain routes.

Migrated from core/oauth.py to shared/auth/oauth_providers.py.
"""
